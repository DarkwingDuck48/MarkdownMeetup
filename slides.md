...
- 🧑‍💻 **Удобство пользователей** - Понятный при чтении, без дополнительной обработки
...
- Системы создания заметок. Notion, Obsidian,  BearNotes …
- Мессенджеры.
...
# Фичи, которые уже стали стандартом
...
Из-за развития этого языка, создалось очень много дополнений к нему.
И не все редакторы из коробки могут обработать тот или иной стиль.
Поэтому нужно использовать продвинутые редакторы как **Obsidian** или **VS Code**.
